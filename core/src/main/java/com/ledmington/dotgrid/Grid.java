...
public final class Grid {
	...
	/**
	 * Returns the coordinates of the grid point closest to the given coordinates. The coordinate system is shifted by
	 * strideX units to the right and by strideY units up. Every point is distant exactly 2*strideX units horizontally
	 * and 2*strideY units vertically. The grid is considered to be in the first quadrant.
	 */
